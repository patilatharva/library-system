...
<div id="import" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="importStudentAction.php" method="post" enctype="multipart/form-data">
            
            <div class="modal-header">
                <h5 class="modal-title">Import Student Data through Excel</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                <div class="modal-body" style="width: 550px;">
                    <b>Step 1: </b>Enter student data in MS Excel in three columns: <i>Class</i>, <i>Roll no.</i> and <i>Name</i>, in precisely that order.<br/><br/>
